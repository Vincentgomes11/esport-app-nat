...
function CampaignDetail({takeToken, navigation}) {
    ...
    useEffect(() => {
        ...
        const response = await fetch('https://esport-app.herokuapp.com/get-campaign-details/'+IdFromParams)
    ...
    const applyCampaign = async () => {
        ...
        const data = await fetch('https://esport-app.herokuapp.com/campaign-apply', {
            method: 'POST',
